...
import com.android.internal.util.projectx.ProjectxActions;
import com.android.internal.util.projectx.KeyButtonInfo;
import com.android.internal.util.projectx.NavbarUtils;
import com.android.systemui.R;

import com.projectx.util.DeviceUtils;

import static com.android.internal.util.projectx.NavbarConstants.*;
...
public class KeyButtonView extends ImageView {
    ...
    protected void doSinglePress() {
        ...
        if (mHasSingleAction) {
            ProjectxActions.launchAction(mContext, mActions.singleAction);
        }
    }
    ...
    private void doDoubleTap() {
        if (mHasDoubleAction) {
            removeCallbacks(mSingleTap);
            ProjectxActions.launchAction(mContext, mActions.doubleTapAction);
        }
    }
    ...
    protected void doLongPress() {
        if (mHasLongAction) {
            removeCallbacks(mSingleTap);
            ProjectxActions.launchAction(mContext, mActions.longPressAction);
            performHapticFeedback(HapticFeedbackConstants.VIRTUAL_KEY);
